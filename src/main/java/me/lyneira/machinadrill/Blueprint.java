...
final class Blueprint {
    ...
    // final static Map<BlockRotation, BlockVector[]> horizontalDrillPattern =
    // new EnumMap<BlockRotation, BlockVector[]>(BlockRotation.class);
    ...
    // private final static Material burningFurnaceMaterial =
    ...
    // centralBase = blueprint.addKey(new BlockVector(0, -1, 0), baseMaterial,
    // mainModule);
    // // Furnace determines direction
    // furnace = blueprint.addKey(new BlockVector(-1, -1, 0),
    // burningFurnaceMaterial, mainModule);
    //
    // // Add non-key blocks
    // // Output chest
    // chest = blueprint.add(new BlockVector(-1, 0, 0), chestMaterial,
    // mainModule);
    //
    ...
    // head = blueprint.add(new BlockVector(1, 0, 0), headMaterialNormal,
    // headNormal);
    ...
    //
    // blueprint.addKey(new BlockVector(0, 1, 0), Material.LEVER,
    // verticalModule);
    // // Anchor
    // blueprint.addKey(new BlockVector(0, 0, 0), anchorMaterial,
    // verticalModule);
    // // Furnace determines direction
    // verticalFurnace = blueprint.addKey(new BlockVector(-1, 0, 0),
    // burningFurnaceMaterial, verticalModule);
    //
    // // Add non-key blocks
    // // Output chest
    // verticalChest = blueprint.add(new BlockVector(1, 0, 0), chestMaterial,
    // verticalModule);
    ...
    // verticalHead = blueprint.addKey(new BlockVector(0, -1, 0),
    // headMaterialNormal, verticalHeadNormal);
    // verticalHeadFast = blueprint.newModule();
    // blueprint.addKey(new BlockVector(0, -1, 0), headMaterialFast,
    // verticalHeadFast);
    //
    ...
    //
    // /**
    // * Detects whether a drill is present at the given BlockLocation. Key
    // blocks
    // * defined above must be detected manually.
    // */
    // public Machina detect(Player player, final BlockLocation anchor, final
    ...
    // if
    // (!BlockData.isSolid(centralBase.getRelative(BlockFace.DOWN).getTypeId()))
    // return null;
    //
    ...
    // }
    //
    // if (EventSimulator.inventoryProtected(yaw, player, anchor, chest,
    // furnace))
    // return null;
    //
    // // Detection was a success.
    // drill = new Drill(this, detectedModules, yaw, player, anchor, chest,
    // head, furnace);
    // if (drill != null && itemInHand != null && itemInHand.getType() ==
    // rotateMaterial) {
    // // Support for rotation on a non-activated drill
    // drill.doRotate(anchor,
    ...
    // }
    //
    // if (EventSimulator.inventoryProtected(yaw, player, anchor, verticalChest,
    // verticalFurnace))
    // return null;
    //
    // // Detection was a success.
    // drill = new Drill(this, detectedModules, yaw, player, anchor,
    // verticalChest, verticalHead, verticalFurnace);
    // break;
    // }
    // }
    // if (drill != null)
